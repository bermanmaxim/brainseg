...
function [net, stats] = cnnTrain(net, imdb, getBatch, varargin)
...
opts.ratio = 0.5; % maximum ratio negatives/positives when balancing
...
for epoch=start+1:opts.numEpochs
  ...
  if opts.balanced
      ...
      thisratio = length(negatives) / length(positives);
      ...
      params.train = [positives; negatives]; % don't forget to suffle.
  else
